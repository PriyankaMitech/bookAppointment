                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        <a href="<?=base_url(); ?>auth-normal-sign-in.html">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            ...
                                            <a href="<?=base_url(); ?>auth-normal-sign-in.html"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="<?=base_url(); ?>auth-sign-up.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                            ...
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-2.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-3.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="to-do-list">
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-2.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-3.jpg" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-4.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="#!"><img src="<?=base_url(); ?>assets/images/avatar-2.jpg" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
