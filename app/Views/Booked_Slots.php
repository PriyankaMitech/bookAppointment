                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                    ...
                                    <h4>List Of Future Appoinment</h4>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="page-header-breadcrumb">
                                ...
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a href="#!">List Of Future Appoinment</a>
                                        ...
                                        <table class="table tabler table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $slot['timestartslot']; ?> </td>
        ...
        $.ajax({
            ...
            success: function(slots) {
                ...
                if (slots.length === 0) {
                    ...
                    var selectDropdown = '<select id="slot_select" >';
