...
<!-- 
                        ...
                        <div class="form-wizard-header col-lg-12 col-md-12 col-12">
                            ...
                            <p>New Kundali Making - Astrologer In Pune</p>
                            ...
                            <div class="form-wizard">
                                ...
                                <form action="<?=base_url(); ?>kundali" method="post" role="form">
                                    ...
                                    <fieldset class="wizard-fieldset show">
                                        ...
                                        <h4 class="text-center">Contact Person Information</h4>
                                        ...
                                        <div class="row mt-4 mb-2">
                                            ...
                                            <div class="col-lg-6 col-md-4 col-12 p-3">
                                       ...
                                       <h4 class="text-center">Charting Kundali for (नविन कुडली बनवण्यासाठी माहिती द्या)</h4>
                                    ...
                                    <fieldset class="wizard-fieldset">
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-12">
                                                ...
                                                <label for="address_on_kundali">Address ( पत्ता )
