                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" method="post" action="<?=base_url(); ?>login">
                            <div class="text-center">
                                <img src="<?=base_url(); ?>assets/images/auth/logo-dark.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                <div class="row m-t-25 text-left">
                                    ...
                                    <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                        <a href="<?=base_url(); ?>auth-reset-password.html" class="text-right f-w-600 text-inverse"> Forgot Your Password?</a>
                                    </div>
                                </div>
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="submit" name="submit" value="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign in</button>
                                    </div>
                                </div>
                                <hr/>
                                <div class="row">
